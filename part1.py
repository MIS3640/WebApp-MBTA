...
url1 = (f"https://api-v3.mbta.com/stops?sort=distance&filter%5Blatitude%5D=42.393668&filter%5Blongitude%5D=-71.032545")
f = urllib.request.urlopen(url1)
response_text1 = f.read().decode('utf-8')
response_data1 = json.loads(response_text1)
# pprint(response_data1)
...
# print("is wheelchair:", response_data1["data"][0]["attributes"]['wheelchair_boarding'])
